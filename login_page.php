...
<body>
	...
	<div class="d-flex p-2 justify-content-center page-content">
		...
		<form class="sign" id="sign-up" action='login.php' method="post">
			...
			<button id="login_b" class="login_button" form="sign-up" type="submit" >Log In</button>

			<p class="line"><span>or</span></p>

			<button id="sign_b" class="sign_button" type="button" onclick="document.location='signup_page.php'" >Sign Up</button>
